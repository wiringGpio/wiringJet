...
void gpioTerminate(int restoreAllRegisters)
{
	// Stopping threads
	global_int = 0;
	...
	// Option to restoring registers to their previous state
	if(restoreAllRegisters == 1)
	{	
		Log(LogLevelInfo, "jetgpio.c", "gpioTerminate", "Restoring all registers");
